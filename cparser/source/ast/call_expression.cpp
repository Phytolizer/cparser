...
cc::ast::call_expression::call_expression(std::unique_ptr<expression_syntax> callee,
        token&& open_parenthesis_token, separated_syntax_list<expression_syntax> arguments,
...
const cc::ast::expression_syntax& cc::ast::call_expression::callee() const noexcept {
    return *m_callee;
}
const cc::token& cc::ast::call_expression::open_parenthesis_token() const noexcept {
    return m_open_parenthesis_token;
}
const cc::ast::separated_syntax_list<cc::ast::expression_syntax>&
